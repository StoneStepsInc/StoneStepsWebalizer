...
template bool berkeleydb_t::iterator<unode_t>::next(storable_t<unode_t>& node, unode_t::s_unpack_cb_t<> upcb);

template class berkeleydb_t::reverse_iterator<unode_t>;
template bool berkeleydb_t::reverse_iterator<unode_t>::prev(storable_t<unode_t>& node, unode_t::s_unpack_cb_t<> upcb);

template bool berkeleydb_t::table_t::put_node(const unode_t& node, storage_info_t& strg_info);
template bool berkeleydb_t::table_t::get_node_by_id(storable_t<unode_t>& node, unode_t::s_unpack_cb_t<> upcb) const;
template bool berkeleydb_t::table_t::get_node_by_value(storable_t<unode_t>& node, unode_t::s_unpack_cb_t<> upcb) const;
...
template bool berkeleydb_t::iterator<hnode_t>::next(storable_t<hnode_t>& node, hnode_t::s_unpack_cb_t<> upcb);
template bool berkeleydb_t::iterator<hnode_t>::next(storable_t<hnode_t>& node, hnode_t::s_unpack_cb_t<storable_t<vnode_t>&, storable_t<unode_t>&> upcb, storable_t<vnode_t>& vnode, storable_t<unode_t>& unode);

template class berkeleydb_t::reverse_iterator<hnode_t>;
template bool berkeleydb_t::reverse_iterator<hnode_t>::prev(storable_t<hnode_t>& node, hnode_t::s_unpack_cb_t<> upcb);
template bool berkeleydb_t::reverse_iterator<hnode_t>::prev(storable_t<hnode_t>& node, hnode_t::s_unpack_cb_t<storable_t<vnode_t>&, storable_t<unode_t>&> upcb, storable_t<vnode_t>& vnode, storable_t<unode_t>& unode);

template bool berkeleydb_t::table_t::put_node<hnode_t>(const hnode_t& hnode, storage_info_t& strg_info);

template bool berkeleydb_t::table_t::get_node_by_id(storable_t<hnode_t>& hnode, hnode_t::s_unpack_cb_t<> upcb) const;
template bool berkeleydb_t::table_t::get_node_by_id(storable_t<hnode_t>& hnode, hnode_t::s_unpack_cb_t<storable_t<vnode_t>&, storable_t<unode_t>&> upcb, storable_t<vnode_t>& vnode, storable_t<unode_t>& unode) const;

template bool berkeleydb_t::table_t::get_node_by_value(storable_t<hnode_t>& node, hnode_t::s_unpack_cb_t<storable_t<vnode_t>&, storable_t<unode_t>&> upcb, storable_t<vnode_t>& vnode, storable_t<unode_t>& unode) const;

template bool database_t::get_hnode_by_id(storable_t<hnode_t>& hnode, hnode_t::s_unpack_cb_t<> upcb) const;
template bool database_t::get_hnode_by_id(storable_t<hnode_t>& hnode, hnode_t::s_unpack_cb_t<void*> upcb, void *arg) const;

template bool database_t::get_hnode_by_value(storable_t<hnode_t>& hnode, hnode_t::s_unpack_cb_t<> upcb) const;
template bool database_t::get_hnode_by_value(storable_t<hnode_t>& hnode, hnode_t::s_unpack_cb_t<void*> upcb, void *arg) const;
...
template bool berkeleydb_t::table_t::get_node_by_id(storable_t<vnode_t>& vnode, vnode_t::s_unpack_cb_t<storable_t<unode_t>&> upcb, storable_t<unode_t>& unode) const;
...
template bool berkeleydb_t::iterator<vnode_t>::next(storable_t<vnode_t>& node, vnode_t::s_unpack_cb_t<void*, storable_t<hnode_t>&, storable_t<unode_t>&> upcb, void *arg, storable_t<hnode_t>& hnode, storable_t<unode_t>& unode);
...
template bool berkeleydb_t::table_t::get_node_by_value(storable_t<dlnode_t>& node, dlnode_t::s_unpack_cb_t<void*, storable_t<hnode_t>&> upcb, void *arg, storable_t<hnode_t>& hnode) const;

template bool database_t::get_dlnode_by_id(storable_t<dlnode_t>& dlnode, dlnode_t::s_unpack_cb_t<void*, storable_t<hnode_t>&> upcb, void *arg, storable_t<hnode_t>& hnode) const;
template bool database_t::get_dlnode_by_value(storable_t<dlnode_t>& dlnode, dlnode_t::s_unpack_cb_t<void*, const storable_t<hnode_t>&>, void *arg, const storable_t<hnode_t>& hnode) const;
...
template bool berkeleydb_t::iterator<dlnode_t>::next(storable_t<dlnode_t>& node, dlnode_t::s_unpack_cb_t<void*, storable_t<hnode_t>&> upcb, void *arg, storable_t<hnode_t>& hnode);

template class berkeleydb_t::reverse_iterator<dlnode_t>;
template bool berkeleydb_t::reverse_iterator<dlnode_t>::prev(storable_t<dlnode_t>& node, dlnode_t::s_unpack_cb_t<void*, storable_t<hnode_t>&> upcb, void *arg, storable_t<hnode_t>& hnode);

// active downloads
template bool berkeleydb_t::table_t::put_node<danode_t>(const danode_t& hnode, storage_info_t& strg_info);
template bool berkeleydb_t::table_t::get_node_by_id(storable_t<danode_t>& node, danode_t::s_unpack_cb_t<> upcb = NULL) const;
...
template bool berkeleydb_t::iterator<danode_t>::next(storable_t<danode_t>& danode, danode_t::s_unpack_cb_t<void*, storable_t<dlnode_t>&, storable_t<hnode_t>&> upcb, void *arg, storable_t<dlnode_t>& dlnode, storable_t<hnode_t>& hnode);
...
template bool berkeleydb_t::iterator<anode_t>::next(storable_t<anode_t>& node, anode_t::s_unpack_cb_t<> upcb);

template class berkeleydb_t::reverse_iterator<anode_t>;
template bool berkeleydb_t::reverse_iterator<anode_t>::prev(storable_t<anode_t>& node, anode_t::s_unpack_cb_t<> upcb);

template bool berkeleydb_t::table_t::put_node<anode_t>(const anode_t& node, storage_info_t& strg_info);
template bool berkeleydb_t::table_t::get_node_by_id(storable_t<anode_t>& node, anode_t::s_unpack_cb_t<> upcb = NULL) const;
template bool berkeleydb_t::table_t::get_node_by_value(storable_t<anode_t>& node, anode_t::s_unpack_cb_t<> upcb) const;
...
template bool berkeleydb_t::iterator<rnode_t>::next(storable_t<rnode_t>& node, rnode_t::s_unpack_cb_t<> upcb);

template class berkeleydb_t::reverse_iterator<rnode_t>;
template bool berkeleydb_t::reverse_iterator<rnode_t>::prev(storable_t<rnode_t>& node, rnode_t::s_unpack_cb_t<> upcb);

template bool berkeleydb_t::table_t::put_node<rnode_t>(const rnode_t& node, storage_info_t& strg_info);
template bool berkeleydb_t::table_t::get_node_by_id(storable_t<rnode_t>& node, rnode_t::s_unpack_cb_t<> upcb = NULL) const;
template bool berkeleydb_t::table_t::get_node_by_value(storable_t<rnode_t>& node, rnode_t::s_unpack_cb_t<> upcb) const;
...
template bool berkeleydb_t::iterator<snode_t>::next(storable_t<snode_t>& node, snode_t::s_unpack_cb_t<> upcb);

template class berkeleydb_t::reverse_iterator<snode_t>;
template bool berkeleydb_t::reverse_iterator<snode_t>::prev(storable_t<snode_t>& node, snode_t::s_unpack_cb_t<> upcb);

template bool berkeleydb_t::table_t::put_node<snode_t>(const snode_t& node, storage_info_t& strg_info);
template bool berkeleydb_t::table_t::get_node_by_id(storable_t<snode_t>& node, snode_t::s_unpack_cb_t<> upcb = NULL) const;
template bool berkeleydb_t::table_t::get_node_by_value(storable_t<snode_t>& unode, snode_t::s_unpack_cb_t<> upcb) const;
...
template bool berkeleydb_t::iterator<inode_t>::next(storable_t<inode_t>& node, inode_t::s_unpack_cb_t<> upcb);

template class berkeleydb_t::reverse_iterator<inode_t>;
template bool berkeleydb_t::reverse_iterator<inode_t>::prev(storable_t<inode_t>& node, inode_t::s_unpack_cb_t<> upcb);

template bool berkeleydb_t::table_t::put_node<inode_t>(const inode_t& node, storage_info_t& strg_info);
template bool berkeleydb_t::table_t::get_node_by_id(storable_t<inode_t>& node, inode_t::s_unpack_cb_t<> upcb = NULL) const;
template bool berkeleydb_t::table_t::get_node_by_value(storable_t<inode_t>& node, inode_t::s_unpack_cb_t<> upcb) const;
...
template bool berkeleydb_t::table_t::get_node_by_id(storable_t<rcnode_t>& node, rcnode_t::s_unpack_cb_t<> upcb = NULL) const;
template bool berkeleydb_t::table_t::get_node_by_value(storable_t<rcnode_t>& node, rcnode_t::s_unpack_cb_t<> upcb) const;
...
template bool berkeleydb_t::iterator<rcnode_t>::next(storable_t<rcnode_t>& node, rcnode_t::s_unpack_cb_t<> upcb);

template class berkeleydb_t::reverse_iterator<rcnode_t>;
template bool berkeleydb_t::reverse_iterator<rcnode_t>::prev(storable_t<rcnode_t>& node, rcnode_t::s_unpack_cb_t<> upcb);

// status codes
template bool berkeleydb_t::table_t::put_node<scnode_t>(const scnode_t& node, storage_info_t& strg_info);
template bool berkeleydb_t::table_t::get_node_by_id(storable_t<scnode_t>& node, scnode_t::s_unpack_cb_t<> upcb = NULL) const;
...
template bool berkeleydb_t::table_t::get_node_by_id(storable_t<daily_t>& node, daily_t::s_unpack_cb_t<> upcb = NULL) const;
...
template bool berkeleydb_t::table_t::get_node_by_id(storable_t<hourly_t>& node, hourly_t::s_unpack_cb_t<> upcb = NULL) const;
...
template bool berkeleydb_t::table_t::get_node_by_id(storable_t<totals_t>& node, totals_t::s_unpack_cb_t<> upcb = NULL) const;

// country codes
template bool berkeleydb_t::table_t::put_node<ccnode_t>(const ccnode_t& node, storage_info_t& strg_info);
template bool berkeleydb_t::table_t::get_node_by_id(storable_t<ccnode_t>& node, ccnode_t::s_unpack_cb_t<> upcb = NULL) const;
...
template bool berkeleydb_t::iterator<ccnode_t>::next(storable_t<ccnode_t>& node, ccnode_t::s_unpack_cb_t<> upcb);

template class berkeleydb_t::reverse_iterator<ccnode_t>;
template bool berkeleydb_t::reverse_iterator<ccnode_t>::prev(storable_t<ccnode_t>& node, ccnode_t::s_unpack_cb_t<> upcb);

// cities
template bool berkeleydb_t::table_t::put_node<ctnode_t>(const ctnode_t& node, storage_info_t& strg_info);
template bool berkeleydb_t::table_t::get_node_by_id(storable_t<ctnode_t>& node, ctnode_t::s_unpack_cb_t<> upcb = NULL) const;
...
template bool berkeleydb_t::iterator<ctnode_t>::next(storable_t<ctnode_t>& node, ctnode_t::s_unpack_cb_t<> upcb);

template class berkeleydb_t::reverse_iterator<ctnode_t>;
template bool berkeleydb_t::reverse_iterator<ctnode_t>::prev(storable_t<ctnode_t>& node, ctnode_t::s_unpack_cb_t<> upcb);

// system
template bool berkeleydb_t::table_t::put_node<sysnode_t>(const sysnode_t& node, storage_info_t& strg_info);
template bool berkeleydb_t::table_t::get_node_by_id(storable_t<sysnode_t>& node, sysnode_t::s_unpack_cb_t<> upcb = NULL) const;
