...
{
   // the explicit string_t temporary is required for GCC v5.4
   ln_htab.emplace(string_t("language"), &language);
   ln_htab.emplace(string_t("language_code"), &language_code);

   ln_htab.emplace(string_t("msg_processed"), &msg_processed);
   ln_htab.emplace(string_t("msg_records"), &msg_records);
   ln_htab.emplace(string_t("msg_addresses"), &msg_addresses);
   ln_htab.emplace(string_t("msg_ignored"), &msg_ignored);
   ln_htab.emplace(string_t("msg_bad"), &msg_bad);
   ln_htab.emplace(string_t("msg_in"), &msg_in);
   ln_htab.emplace(string_t("msg_seconds"), &msg_seconds);
   ln_htab.emplace(string_t("msg_runtime"), &msg_runtime);
   ln_htab.emplace(string_t("msg_dnstime"), &msg_dnstime);
   ln_htab.emplace(string_t("msg_mnttime"), &msg_mnttime);
   ln_htab.emplace(string_t("msg_rpttime"), &msg_rpttime);
   ln_htab.emplace(string_t("msg_cmpctdb"), &msg_cmpctdb);
   ln_htab.emplace(string_t("msg_nofile"), &msg_nofile);
   ln_htab.emplace(string_t("msg_file_err"), &msg_file_err);
   ln_htab.emplace(string_t("msg_use_help"), &msg_use_help);
   ln_htab.emplace(string_t("msg_fpos_err"), &msg_fpos_err);

   ln_htab.emplace(string_t("msg_log_err"), &msg_log_err);
   ln_htab.emplace(string_t("msg_log_use"), &msg_log_use);
   ln_htab.emplace(string_t("msg_log_done"), &msg_log_done);
   ln_htab.emplace(string_t("msg_dir_err"), &msg_dir_err);
   ln_htab.emplace(string_t("msg_dir_use"), &msg_dir_use);
   ln_htab.emplace(string_t("msg_cur_dir"), &msg_cur_dir);
   ln_htab.emplace(string_t("msg_hostname"), &msg_hostname);
   ln_htab.emplace(string_t("msg_ign_hist"), &msg_ign_hist);
   ln_htab.emplace(string_t("msg_no_hist"), &msg_no_hist);
   ln_htab.emplace(string_t("msg_get_hist"), &msg_get_hist);
   ln_htab.emplace(string_t("msg_put_hist"), &msg_put_hist);
   ln_htab.emplace(string_t("msg_hist_err"), &msg_hist_err);
   ln_htab.emplace(string_t("msg_bad_hist"), &msg_bad_hist);
   ln_htab.emplace(string_t("msg_bad_conf"), &msg_bad_conf);
   ln_htab.emplace(string_t("msg_bad_key"), &msg_bad_key);
   ln_htab.emplace(string_t("msg_bad_date"), &msg_bad_date);
   ln_htab.emplace(string_t("msg_ign_nscp"), &msg_ign_nscp);
   ln_htab.emplace(string_t("msg_bad_rec"), &msg_bad_rec);
   ln_htab.emplace(string_t("msg_no_vrec"), &msg_no_vrec);
   ln_htab.emplace(string_t("msg_gen_rpt"), &msg_gen_rpt);
   ln_htab.emplace(string_t("msg_gen_sum"), &msg_gen_sum);
   ln_htab.emplace(string_t("msg_get_data"), &msg_get_data);
   ln_htab.emplace(string_t("msg_put_data"), &msg_put_data);
   ln_htab.emplace(string_t("msg_no_data"), &msg_no_data);
   ln_htab.emplace(string_t("msg_bad_data"), &msg_bad_data);
   ...
   ln_htab.emplace(string_t("msg_use_lang"), &msg_use_lang);
   ln_htab.emplace(string_t("msg_use_db"), &msg_use_db);

   ln_htab.emplace(string_t("msg_dns_nocf"), &msg_dns_nocf);
   ln_htab.emplace(string_t("msg_dns_nodb"), &msg_dns_nodb);
   ln_htab.emplace(string_t("msg_dns_nolk"), &msg_dns_nolk);
   ln_htab.emplace(string_t("msg_dns_usec"), &msg_dns_usec);
   ln_htab.emplace(string_t("msg_dns_rslv"), &msg_dns_rslv);
   ...
   ln_htab.emplace(string_t("msg_big_date"), &msg_big_date);
   ln_htab.emplace(string_t("msg_big_req"), &msg_big_req);
   ln_htab.emplace(string_t("msg_big_ref"), &msg_big_ref);
   ln_htab.emplace(string_t("msg_big_user"), &msg_big_user);
   ln_htab.emplace(string_t("msg_big_url"), &msg_big_url);
   ln_htab.emplace(string_t("msg_big_agnt"), &msg_big_agnt);
   ln_htab.emplace(string_t("msg_big_srch"), &msg_big_srch);
   ln_htab.emplace(string_t("msg_big_one"), &msg_big_one);
   ln_htab.emplace(string_t("msg_no_open"), &msg_no_open);

   ln_htab.emplace(string_t("h_usage1"), &h_usage1);
   ln_htab.emplace(string_t("h_usage2"), &h_usage2);

   ln_htab.emplace(string_t("h_msg"), &h_msg);

   ln_htab.emplace(string_t("msg_hhdr_sp"), &msg_hhdr_sp);
   ln_htab.emplace(string_t("msg_hhdr_gt"), &msg_hhdr_gt);

   ln_htab.emplace(string_t("msg_main_us"), &msg_main_us);
   ln_htab.emplace(string_t("msg_main_per"), &msg_main_per);
   ln_htab.emplace(string_t("msg_main_sum"), &msg_main_sum);
   ln_htab.emplace(string_t("msg_main_da"), &msg_main_da);
   ln_htab.emplace(string_t("msg_main_mt"), &msg_main_mt);

   ln_htab.emplace(string_t("msg_main_plst"), &msg_main_plst);
   ln_htab.emplace(string_t("msg_main_pmns"), &msg_main_pmns);

   ln_htab.emplace(string_t("msg_hmth_du"), &msg_hmth_du);
   ln_htab.emplace(string_t("msg_hmth_hu"), &msg_hmth_hu);

   ln_htab.emplace(string_t("msg_h_by"), &msg_h_by);
   ln_htab.emplace(string_t("msg_h_avg"), &msg_h_avg);
   ln_htab.emplace(string_t("msg_h_max"), &msg_h_max);
   ln_htab.emplace(string_t("msg_h_total"), &msg_h_total);
   ln_htab.emplace(string_t("msg_h_totals"), &msg_h_totals);
   ln_htab.emplace(string_t("msg_h_day"), &msg_h_day);
   ln_htab.emplace(string_t("msg_h_mth"), &msg_h_mth);
   ln_htab.emplace(string_t("msg_h_hour"), &msg_h_hour);
   ln_htab.emplace(string_t("msg_h_hits"), &msg_h_hits);
   ln_htab.emplace(string_t("msg_h_pages"), &msg_h_pages);
   ln_htab.emplace(string_t("msg_h_visits"), &msg_h_visits);
   ln_htab.emplace(string_t("msg_h_files"), &msg_h_files);
   ln_htab.emplace(string_t("msg_h_hosts"), &msg_h_hosts);
   ln_htab.emplace(string_t("msg_h_xfer"), &msg_h_xfer);
   ln_htab.emplace(string_t("msg_h_avgtime"), &msg_h_avgtime);
   ln_htab.emplace(string_t("msg_h_maxtime"), &msg_h_maxtime);
   ln_htab.emplace(string_t("msg_h_hname"), &msg_h_hname);
   ln_htab.emplace(string_t("msg_h_host"), &msg_h_host);
   ln_htab.emplace(string_t("msg_h_ipaddr"), &msg_h_ipaddr);
   ln_htab.emplace(string_t("msg_h_url"), &msg_h_url);
   ln_htab.emplace(string_t("msg_h_agent"), &msg_h_agent);
   ln_htab.emplace(string_t("msg_h_ref"), &msg_h_ref);
   ln_htab.emplace(string_t("msg_h_ctry"), &msg_h_ctry);
   ln_htab.emplace(string_t("msg_h_ccode"), &msg_h_ccode);
   ln_htab.emplace(string_t("msg_h_search"), &msg_h_search);
   ln_htab.emplace(string_t("msg_h_uname"), &msg_h_uname);
   ln_htab.emplace(string_t("msg_h_type"), &msg_h_type);
   ln_htab.emplace(string_t("msg_h_status"), &msg_h_status);
   ln_htab.emplace(string_t("msg_h_duration"), &msg_h_duration);
   ln_htab.emplace(string_t("msg_h_method"), &msg_h_method);
   ln_htab.emplace(string_t("msg_h_download"), &msg_h_download);
   ln_htab.emplace(string_t("msg_h_count"), &msg_h_count);
   ln_htab.emplace(string_t("msg_h_time"), &msg_h_time);
   ln_htab.emplace(string_t("msg_h_spammer"), &msg_h_spammer);
   ln_htab.emplace(string_t("msg_h_urls"), &msg_h_urls);
   ln_htab.emplace(string_t("msg_h_refs"), &msg_h_refs);
   ln_htab.emplace(string_t("msg_h_agents"), &msg_h_agents);
   ln_htab.emplace(string_t("msg_h_chosts"), &msg_h_chosts);
   ...
   ln_htab.emplace(string_t("msg_h_as_num"), &msg_h_as_num);
   ln_htab.emplace(string_t("msg_h_as_org"), &msg_h_as_org);

   ln_htab.emplace(string_t("msg_hlnk_sum"), &msg_hlnk_sum);
   ln_htab.emplace(string_t("msg_hlnk_ds"), &msg_hlnk_ds);
   ...
   ln_htab.emplace(string_t("msg_hlnk_r"), &msg_hlnk_r);
   ln_htab.emplace(string_t("msg_hlnk_en"), &msg_hlnk_en);
   ln_htab.emplace(string_t("msg_hlnk_ex"), &msg_hlnk_ex);
   ln_htab.emplace(string_t("msg_hlnk_sr"), &msg_hlnk_sr);
   ln_htab.emplace(string_t("msg_hlnk_i"), &msg_hlnk_i);
   ln_htab.emplace(string_t("msg_hlnk_err"), &msg_hlnk_err);
   ln_htab.emplace(string_t("msg_hlnk_dl"), &msg_hlnk_dl);

   ln_htab.emplace(string_t("msg_mtot_ms"), &msg_mtot_ms);
   ln_htab.emplace(string_t("msg_mtot_th"), &msg_mtot_th);
   ln_htab.emplace(string_t("msg_mtot_tf"), &msg_mtot_tf);
   ln_htab.emplace(string_t("msg_mtot_tp"), &msg_mtot_tp);
   ln_htab.emplace(string_t("msg_mtot_tv"), &msg_mtot_tv);
   ln_htab.emplace(string_t("msg_mtot_tx"), &msg_mtot_tx);
   ln_htab.emplace(string_t("msg_mtot_us"), &msg_mtot_us);
   ln_htab.emplace(string_t("msg_mtot_ur"), &msg_mtot_ur);
   ln_htab.emplace(string_t("msg_mtot_ua"), &msg_mtot_ua);
   ln_htab.emplace(string_t("msg_mtot_uu"), &msg_mtot_uu);
   ln_htab.emplace(string_t("msg_mtot_ui"), &msg_mtot_ui);
   ln_htab.emplace(string_t("msg_mtot_mhd"), &msg_mtot_mhd);
   ln_htab.emplace(string_t("msg_mtot_mhh"), &msg_mtot_mhh);
   ln_htab.emplace(string_t("msg_mtot_mfd"), &msg_mtot_mfd);
   ln_htab.emplace(string_t("msg_mtot_mpd"), &msg_mtot_mpd);
   ln_htab.emplace(string_t("msg_mtot_mvd"), &msg_mtot_mvd);
   ln_htab.emplace(string_t("msg_mtot_mkd"), &msg_mtot_mkd);
   ln_htab.emplace(string_t("msg_mtot_rc"), &msg_mtot_rc);
   ln_htab.emplace(string_t("msg_mtot_dl"), &msg_mtot_dl);
   ln_htab.emplace(string_t("msg_mtot_tcv"), &msg_mtot_tcv);
   ln_htab.emplace(string_t("msg_mtot_tch"), &msg_mtot_tch);
   ln_htab.emplace(string_t("msg_mtot_hcr"), &msg_mtot_hcr);
   ln_htab.emplace(string_t("msg_mtot_cvd"), &msg_mtot_cvd);
   ln_htab.emplace(string_t("msg_mtot_conv"), &msg_mtot_conv);
   ln_htab.emplace(string_t("msg_mtot_rtot"), &msg_mtot_rtot);
   ln_htab.emplace(string_t("msg_mtot_perf"), &msg_mtot_perf);
   ln_htab.emplace(string_t("msg_mtot_hdt"), &msg_mtot_hdt);
   ln_htab.emplace(string_t("msg_mtot_terr"), &msg_mtot_terr);

   ln_htab.emplace(string_t("msg_mtot_htot"), &msg_mtot_htot);
   ln_htab.emplace(string_t("msg_mtot_stot"), &msg_mtot_stot);

   ln_htab.emplace(string_t("msg_mtot_sph"), &msg_mtot_sph);
   ln_htab.emplace(string_t("msg_mtot_spf"), &msg_mtot_spf);
   ln_htab.emplace(string_t("msg_mtot_spp"), &msg_mtot_spp);

   ln_htab.emplace(string_t("msg_mtot_mhv"), &msg_mtot_mhv);
   ln_htab.emplace(string_t("msg_mtot_mfv"), &msg_mtot_mfv);
   ln_htab.emplace(string_t("msg_mtot_mpv"), &msg_mtot_mpv);
   ln_htab.emplace(string_t("msg_mtot_mdv"), &msg_mtot_mdv);
   ln_htab.emplace(string_t("msg_mtot_mkv"), &msg_mtot_mkv);

   ln_htab.emplace(string_t("msg_dtot_ds"), &msg_dtot_ds);

   ln_htab.emplace(string_t("msg_htot_hs"), &msg_htot_hs);

   ln_htab.emplace(string_t("msg_ctry_use"), &msg_ctry_use);

   ln_htab.emplace(string_t("msg_top_top"), &msg_top_top);
   ln_htab.emplace(string_t("msg_top_of"), &msg_top_of);
   ln_htab.emplace(string_t("msg_top_s"), &msg_top_s);
   ln_htab.emplace(string_t("msg_top_u"), &msg_top_u);
   ln_htab.emplace(string_t("msg_top_r"), &msg_top_r);
   ...
   ln_htab.emplace(string_t("msg_top_i"), &msg_top_i);
   ln_htab.emplace(string_t("msg_v_hosts"), &msg_v_hosts);
   ln_htab.emplace(string_t("msg_v_urls"), &msg_v_urls);
   ln_htab.emplace(string_t("msg_v_refs"), &msg_v_refs);
   ln_htab.emplace(string_t("msg_v_agents"), &msg_v_agents);
   ln_htab.emplace(string_t("msg_v_search"), &msg_v_search);
   ln_htab.emplace(string_t("msg_v_users"), &msg_v_users);
   ln_htab.emplace(string_t("msg_h_errors"), &msg_h_errors);
   ln_htab.emplace(string_t("msg_v_errors"), &msg_v_errors);
   ln_htab.emplace(string_t("msg_h_downloads"), &msg_h_downloads);
   ln_htab.emplace(string_t("msg_v_downloads"), &msg_v_downloads);
   ln_htab.emplace(string_t("msg_ref_dreq"), &msg_ref_dreq);
   ln_htab.emplace(string_t("msg_max_items"), &msg_max_items);

   ln_htab.emplace(string_t("msg_misc_pages"), &msg_misc_pages);
   ln_htab.emplace(string_t("msg_misc_visitors"), &msg_misc_visitors);
   ln_htab.emplace(string_t("msg_misc_robots"), &msg_misc_robots);

   ln_htab.emplace(string_t("s_month"), &s_month);
   ln_htab.emplace(string_t("l_month"), &l_month);

   ln_htab.emplace(string_t("msg_unit_pfx"), &msg_unit_pfx);
   ln_htab.emplace(string_t("msg_xfer_unit"), &msg_xfer_unit);

   ln_htab.emplace(string_t("response"), &response);

   ln_htab.emplace(string_t("msg_title"), &msg_title);
   ln_htab.emplace(string_t("msg_h_other"), &msg_h_other);

   ln_htab.emplace(string_t("ctry"), &ctry);

   ln_htab.emplace(string_t("msg_h_city"), &msg_h_city);
}
