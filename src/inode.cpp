...
size_t inode_t::s_unpack_data(const void *buffer, size_t bufsize, s_unpack_cb_t<param_t ...> upcb, param_t ... param)
{
   serializer_t sr(buffer, bufsize);
...
int64_t inode_t::s_compare_hits(const void *buf1, size_t buf1size, const void *buf2, size_t buf2size)
{
...
//
template size_t inode_t::s_unpack_data(const void *buffer, size_t bufsize, inode_t::s_unpack_cb_t<> upcb);
